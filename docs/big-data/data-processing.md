...
- Enables deep analysis of big data sets.
...
- Data is still processed a batch at a time.
...
- Use cases:
    - Better suited for real-time monitoring and response functions.
    - Mobile and web applications, e-commerce purchases, in-game player activity, social networks, financial trading floors, and telemetry from connected devices.
