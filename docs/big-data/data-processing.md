...
- Can be accomplished using purpose-built stream processing engines such as Apache Storm.
- Use cases:
...
- Stateful transformations combine data across multiple batches.
    ...
    - This is achieved by creating data checkpoints on streaming applications.
...
- Storm can provide better latency with fewer restrictions.
...
- Storm guarantees that every event will be processed "at least once".
